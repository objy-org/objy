...
var checkAuthroisations = function(obj, authorisations, condition, app) {
        var permCheck = [obj];
    	...
    	console.log(Query.query(permCheck, query, Query.undot))

    }



    checkAuthroisations({name: "test1"}, {crm: [{query:{type: "test"}, perm:"r"}, {query: {name: "test1"}, perm: "r"}]}, 'd')
