...
describe('Structure', function () {
    ...
    test('should have mutated the structure', function (done) {
        ...
        obj.setProperty('weight', testStringFinal).removeProperty('test').removePermission('admin').removeApplication('one').removeOnCreate('init');
