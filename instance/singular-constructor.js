        ...
        Obj: function(obj, role, instance, params) {
            ...
            Object.getPrototypeOf(this).add = function(success, error, client) {
                ...
                var addFn = function(obj) {
                    ...
                    if (!OBJY.checkPermissions(instance.activeUser, instance.activeApp, obj, 'c', false, instance)) return error({ error: "Lack of Permissions" });
            ...
            Object.getPrototypeOf(this).update = function(success, error, client) {
                ...
                if (!OBJY.checkPermissions(instance.activeUser, instance.activeApp, thisRef, 'u', false, instance)) return error({ error: 'Lack of Permissions' })
            ...
            Object.getPrototypeOf(this).remove = function(success, error, client) {
                ...
                if (params.dirty) {
                    ...
                    OBJY.getObjectById(this.role, this._id, function(data) {
                        ...
                        if(!OBJY.checkAuthroisations(data, instance.activeUser, "d", instance.activeApp, instance)) return error({ error: 'Lack of Permissions' })
                ...
                if (!OBJY.checkPermissions(instance.activeUser, instance.activeApp, thisRef, 'd', false, instance)) return error({ error: 'Lack of Permissions' })
