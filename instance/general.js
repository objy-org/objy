...
module.exports = function(OBJY) {
    return {
        ...
        execProcessorAction: function(dsl, obj, prop, data, callback, context, client, options) {
            let processorApp = context?.activeApp || (obj.applications || {})[0]
            OBJY.Logger.log('triggering dsl');
            this.processors[obj.role].execute(dsl, obj, prop, data, callback, client, processorApp, context?.activeUser, options);
        },
